...
export default function ClientTourOrderForm({ 
  productId, 
  productName, 
  productPrice, 
  stockStatus, 
  minPeserta, 
  diskonMinimalPeserta, 
  diskonNominal 
}: TourOrderFormProps) {
  ...
  useEffect(() => {
    ...
    if (!token) {
      toast.error("Silakan login terlebih dahulu untuk melakukan booking paket wisata.", {
  ...
  const handleBooking = async (e: React.FormEvent) => {
    ...
    const loadToast = toast.loading("Memproses booking & jadwal kunjungan...");
  ...
  const handleSendToWhatsApp = () => {
    ...
    const textMessage = 
`Halo Admin Desa Wisata Bojongrangkas, saya ingin mengkonfirmasi pembayaran booking paket wisata.

*ID Order:* #${finalOrderId}
*Nama Pemesan:* ${finalName}
*Kategori:* Paket Wisata Terpadu
            ...
            <div className="p-6 sm:p-10 overflow-y-auto space-y-6 bg-white text-neutral-800 flex-1">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-4">
                <div>
                  ...
                  <p className="text-xs text-neutral-500">Paket Wisata Terpadu</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 pt-2 border-t">
                <div className="text-[11px] text-neutral-500 max-w-xs space-y-1">
                  ...
                  <p>Terima kasih telah memesan paket wisata di Desa Wisata Bojongrangkas. Konfirmasi WhatsApp Anda telah terkirim ke admin.</p>
                </div>
