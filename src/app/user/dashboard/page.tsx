...
import { 
  ...
  ArrowRight, ShieldCheck, Camera, History, Edit3, CheckCircle2, Package, Clock, AlertTriangle, RefreshCw
} from 'lucide-react';
...
export default function UserDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/20 to-teal-50/30 text-slate-800 pb-16 pt-32 sm:pt-36 px-4 sm:px-6">
      ...
      <main className="max-w-6xl mx-auto space-y-6">
        ...
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-8 text-white shadow-[0_10px_30px_rgba(16,185,129,0.2)] relative overflow-hidden flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="absolute -right-10 -bottom-10 w-48 h-48 bg-white/10 rounded-full blur-2xl pointer-events-none" />
          
          <div className="relative z-10 flex items-center gap-5">
            <div className="relative group shrink-0">
              <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-md border-2 border-white/40 overflow-hidden flex items-center justify-center text-white text-2xl font-bold shadow-md">
                {userAvatar ? (
            ...
            <div>
              ...
              <h2 className="text-2xl font-extrabold tracking-tight">Selamat Datang, {userName}! 👋</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <Link 
            href="/wisata"
            className="group bg-white/80 backdrop-blur-md p-6 rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md hover:border-emerald-500/50 transition-all flex flex-col justify-between"
          >
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Temukan spot wisata alam dan budaya menarik.</p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Booking tempat istirahat nyaman bersama warga.</p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Pilih paket liburan terpadu harga spesial.</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl p-6 border border-slate-200/80 shadow-sm flex flex-col justify-between">
            <div>
              ...
              {isEditing ? (
                <form onSubmit={handleSaveProfile} className="space-y-4 mt-4">
                  <div>
                    ...
                    <input 
                      ...
                      required
                      className="w-full px-4 py-2 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none"
                    />
                  </div>
                  <button 
                    type="submit"
                ...
                <div className="space-y-3 text-xs mt-2">
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/60 flex justify-between items-center">
                    <div>
                      <span className="text-slate-400 block mb-0.5">Nama Akun</span>
            ...
            <p className="text-[11px] text-slate-400 mt-6 italic">
              *Tips: Arahkan kursor ke foto profil di atas untuk mengganti gambar foto avatar kamu secara instan.
            </p>
          </div>
              ...
              {fetchingOrders ? (
                ...
                <div className="space-y-3 max-h-[260px] overflow-y-auto pr-1">
                  {transactions.map((trx) => {
                    ...
                    return (
                      <div key={trx.id} className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/60 flex items-center justify-between gap-3">
                            ...
                            <div className="flex items-center gap-2 text-[10px] text-slate-400 mt-0.5">
                              ...
                              {isExpired ? (
                                <span className="text-rose-600 font-bold flex items-center gap-0.5">
                                  <AlertTriangle size={10} /> Kadaluarsa (<span className="text-red-600 font-black">&gt;</span>24 Jam)
                                </span>
                              ) : isPending ? (
